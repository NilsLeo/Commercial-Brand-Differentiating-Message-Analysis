...
def prepare_model_data(ad_df):
    features = ad_df['superlative_count', 'comparative_count', 'uniqueness_count', 'total_bdm_terms_count', 'total_bdm_terms_pct', 'num_adj_noun_pairs', 'product_cat_keyword_similarity', 'product_brand_keyword_similarity', 'shared_keywords_count']
